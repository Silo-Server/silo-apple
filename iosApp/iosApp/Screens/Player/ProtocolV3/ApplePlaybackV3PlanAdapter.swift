...
enum ApplePlaybackV3PlanAdapter {
    ...
    private static func forcedLoopbackSession(
        ...
        return LoopbackSessionSpec(
            ...
            videoMode: videoMode,
            videoOutputMode: base.videoOutputMode,
            sourceVideoWidth: base.sourceVideoWidth,
            sourceVideoHeight: base.sourceVideoHeight,
            bridgedVideoParameterSets: base.bridgedVideoParameterSets,
