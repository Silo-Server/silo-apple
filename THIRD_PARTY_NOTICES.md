...
| --- | --- | --- | --- |
| AetherEngine 7.13.0 + Silo subtitle, HLS authorization and TrueHD Atmos patches | `455bcd60b2824a691096e22c2e8aa662798504ec` | Swift package target linked into each host app | LGPL-3.0-only with AetherEngine's Apple Store / DRM exception |
...
- Exact source: <https://github.com/Silo-Server/AetherEngine/tree/455bcd60b2824a691096e22c2e8aa662798504ec>
...
Silo uses SwiftLibass 1.4.0 for libass bindings and SwiftAssRenderer 1.3.1
...
The native XCFrameworks contain static `.a` libraries and headers. Silo links
